<template>
  <div class="bussiness_bg">
    ...
    <div class="bussiness_scroll">
      <div v-if="choseTab=='online'" class="bussiness_show">
        <div class="bussiness_card_list">
          <div class="bussiness_card">
            ...
            <div class="card_tips">
              <p class="title">群组数</p>
              <p class="num">{{ courseLabel.groupNum }}</p>
            </div>
          </div>
          <div class="bussiness_card">
            <div class="card_icon">
            ...
            <div class="card_tips">
              <p class="title">群员数量</p>
              <p class="num">{{ courseLabel.memberNum }}</p>
            </div>
          </div>
          <div class="bussiness_card">
            <div class="card_icon">
            ...
            <div class="card_tips">
              <p class="title">计划排课数</p>
              <p class="num">{{ courseLabel.courseNum }}</p>
            </div>
          </div>
          <div class="bussiness_card">
            <div class="card_icon">
            ...
            <div class="card_tips">
              <p class="title">上传课件数</p>
              <p class="num">{{ courseLabel.coursewareNum }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bussiness_table">
          ...
          <div class="table_data">
            <el-table :data="tableData" border tooltip-effect="light">
              <el-table-column label="月份" align="center" prop="months" />
              <el-table-column label="排课数" align="center" prop="allNum"/>
              <el-table-column label="上传课件数" align="center" prop="upNum"/>
        ...
        <div class="bussiness_table">
          <div class="table_data">
            <el-table :data="tableData" border tooltip-effect="light">
              ...
              <el-table-column label="群名" prop="groupName" align="center"/>
              <el-table-column label="群员等级" prop="leavel" align="center"/>
              <el-table-column label="排课数" prop="allNum" align="center"/>
              <el-table-column label="上传课件数" prop="upNum" align="center"/>
      ...
      <div v-if="choseTab=='groupList'" class="bussiness_show" style="padding: 0 20px;">
        <div class="bussiness_charts">
          <div class="charts_fifter">
            <div style="color: #333333;font-size: 16px;font-weight: 700;font-family: 'Arial Negreta', 'Arial Normal', 'Arial';">
              群组排行
...
import { getOnlineInfo, exportOnlineInfo } from '@/api/statement'
export default {
  ...
  methods: {
    bussinessExport() {
      const info = {
        type: this.choseTab == 'online' ? 'online' : (this.choseTab == 'personalList' ? 'onlinePersonal' : 'onlineGroup'),
        startDate: this.startDate,
        endDate: this.endDate
      }
      exportOnlineInfo(info).then(res => {
        let filename = ''
        filename = '线上培训统计导出' + new Date().getTime()
