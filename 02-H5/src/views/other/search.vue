    ...
    <div class='search_his'>
      <div class='search_header'>
        <div class='search'>
          ...
          <mt-field placeholder="搜索喜欢的商品" v-model="searchkey" class='search_input' @keyup.enter.native="searchList"></mt-field>
        </div>
...
export default {
  ...
  methods: {
    ...
    goLink(value) {
      this.$router.togo({
        path: '/proList?type=key&virtual_id=&value=' + value
      })
    },
    searchHis: function () {
      var that = this
    ...
    searchList: function () {
      ...
      self.$router.togo({
        path: '/proList?type=key&virtual_id=&value=' + self.searchkey
      })
    //   wx.navigateTo({
