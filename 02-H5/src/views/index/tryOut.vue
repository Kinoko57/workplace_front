  ...
  <div>
    ...
    <div class="try_out" v-if='isShow'>
      <div class='try_body'>
        ...
        <div class="sale_tab_show" v-if="timeList.length>0">
          <div class='sale_tab'>
            <div :class="item.id==choseId?'sale_nav sale_active':'sale_nav'" v-for='(item,index) in timeList'
              :key='index' @click='choseList(item)'>
            ...
            <div class='t_b_info'>
              ...
              <div>
                <div class='t_b_info_left'>
                  <div class='t_b_other'>
                    <div style='font-size:0.23rem;color:#ff4e79;'>
                ...
                <div class='t_b_info_right'>
                  ...
                  <mt-button size='small' @click='showDetail(item.id)' v-if='item.status==0' class='start'>未开始
                  </mt-button>
                  <mt-button size='small' @click='showDetail(item.id)' v-if='item.status==1' class='running'>免费申领
                  </mt-button>
        ...
        <div class='tryList' v-if='boostList.length>0'>
          <img :src='imgPath+"pro/zhuli.png"' style='width:1.58rem;height:0.56rem;margin:0.2rem 0;' />
