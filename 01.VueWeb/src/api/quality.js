...
export function getComplaintList() {
  return request({
    url: '/oa/qualitylevel-browse.json',
    method: 'GET'
  })
}
...
export function saveComplaint(info) {
  return request({
    url: '/oa/qualitylevel-create.json',
    method: 'POST',
    data: info
  })
}
...
export function updateComplaint(info) {
  return request({
    url: '/oa/qualitylevel-edit-' + info.id + '.json',
    method: 'POST',
    data: info
  })
}
...
export function getComplaintDetail(id) {
  return request({
    url: '/oa/qualityprocessnode-edit-' + id + '.json',
    method: 'GET'
  })
}
...
export function getComplaintType() {
  return request({
    url: '/oa/qualitylevel-getqualitylevellist.json',
    method: 'GET'
  })
}
...
export function getComplaintInfo(info) {
  return request({
    url: '/oa/quaworkflow-browse--' + info.mode + '-' + info.search + '-' + info.orderBy + '-' + info.recTotal + '-' + info.recPerPage + '-' + info.pageID + '.json',
    method: 'GET'
  })
}
// 保存投诉信息
...
export function updateComplaintInfoDetail(info) {
  return request({
    url: '/oa/quality-edit-' + info.id + '.json',
    method: 'POST',
    data: info
  })
}
...
export function viewComplaintInfoDetail(id) {
  return request({
    url: '/oa/quaworkflow-view-' + id + '.json',
    method: 'GET'
  })
}
// 保存投诉回访
export function saveComplaintFollow(id, info) {
  return request({
    url: '/oa/quality-callbackadd-' + id + '.json',
    method: 'POST',
    data: info
  })
}
...
export function handlingComplaint(id, info) {
  return request({
    url: '/oa/quaworkflow-dealmassage-' + id + '.json',
    method: 'POST',
    data: info
  })
}
...
export function getDoComplaintUser() {
  return request({
    url: '/oa/quaworkflow-checklower.json',
    method: 'GET'
  })
}
// 分配投诉
export function allocationComplaint(id, info) {
  return request({
    url: '/oa/quaworkflow-allotmassage-' + id + '.json',
    method: 'POST',
    data: info
  })
}
// 查看投诉详情 跳转页面/oa/quaworkflow-new_view
export function viewComplaintPageDetail(id) {
  return request({
    url: '/oa/quaworkflow-newview-' + id + '.json',
    method: 'GET'
  })
}
// 作废投诉类型
export function banComplaintType(id) {
  return request({
    url: '/oa/qualitylevel-delete-' + id + '.json',
    method: 'GET'
  })
}
// 根据id获取投诉详情oa/quality-edit-ID
export function updateComplaintDetail(id, info) {
  return request({
    url: '/oa/quality-edit-' + id + '.json',
    method: 'POST',
    data: info
  })
}
...
export function banComplaintInfo(id) {
  return request({
    url: '/oa/quaworkflow-invalid-' + id + '.json',
    method: 'GET'
  })
}
...
export function rejectedComplaintInfo(id, info) {
  return request({
    url: '/oa/quaworkflow-rejected-' + id + '.json',
    method: 'POST',
    data: info
  })
}
...
export function passComplaintInfo(id, info) {
  return request({
    url: '/oa/quaworkflow-pass-' + id + '.json',
    method: 'POST',
    data: info
  })
}
...
export function rejectedAllComplaint(id) {
  return request({
    url: '/oa/quaworkflow-forceReject-' + id + '.json',
    method: 'POST'
  })
}