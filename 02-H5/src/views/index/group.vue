  ...
  <div>
    ...
    <div class='sale' v-if='isShow'>
      <div class='sale_body'>
        ...
        <div class='sale_list' v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" infinite-scroll-distance="30" v-if='total>0'>
              ...
              <div class='pro_spec'>
                <div class='pro_price'>
                  <div style='display:flex;align-items:center;'>
                    <span class='peo_nowprice' v-if='item.deal_type==1||item.deal_type==3'>￥{{item.price}}<span style="color:#313131;font-size:0.23rem" v-if="isMember"> / 赚{{item.back_rebate}}</span></span>
                    <span class='peo_nowprice' v-if='item.deal_type>=4'>￥{{item.price}}<span style="color:#313131;font-size:0.23rem" v-if="isMember"> / 赚{{item.back_rebate}}</span></span>
          ...
          <div class='list_bottom' v-if='loading&&total>0'>—————— 我是有底线的 ——————</div>
        </div>
