  ...
  <div>
    ...
    <div class='my_collection' v-if='isShow'>
      ...
      <div class='coll_body'>
        ...
        <div class='coll_list' v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" infinite-scroll-distance="30" v-if='collList.length>0'>
            ...
            <div :class="isEdit==false?'pro_info':'pro_info pro_info_edit'">
              ...
              <div class='pro_spec'>
                ...
                <!-- <div class='pro_icon' @click="goPro(item.goods_id,'/proDetail?type=normal')">
                  <img :src='imgPath+"member/red_car.png"' />
                </div> -->
              </div>
            </div>
          </div>
        ...
        <div class='coll_list_null' v-if='collList.length<=0'>
