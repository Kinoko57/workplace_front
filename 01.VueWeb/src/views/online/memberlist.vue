    ...
    <div class="list_bg">
      <div class="fifter">
        <my-tabs
          ...
          :add="btnPermission('cradlegroupmember_create')"
          :return-show="true"
      ...
      <div class="list_info">
        <div class="info_total">
          <div class="data_total">
            ...
            <el-button v-if="btnPermission('cradlegroupmember_updatestatusall')" plain size="mini" @click="batchstop('remover')">批量移除</el-button>
          </div>
          <div class="export_btn">
            <search-fifter
              :import-show="btnPermission('cradlegroupmember_import')"
              :export-show="btnPermission('cradlegroupmember_export')"
      ...
      <el-scrollbar class="fixed_scroll">
        <el-form
          ...
          <el-form-item label="选择经销商：" prop="agentId">
            <!-- <el-select v-model="listForm.agentId" :disabled="modelType=='edit'" filterable placeholder="请选择名称" filterable style="width:500px">
          ...
          <el-form-item label="群员等级：" prop="leavel">
            <el-select v-model="listForm.leavel" filterable placeholder="请选择群员等级" filterable style="width:500px">
...
export default {
  ...
  data() {
    return {
      submitting: false,
      page_name: 'cradlegroupmember',
      module_name: 'ols',
      typeList: [{ label: '全部群员', name: 'all' }],
      choseTotal: 0,
      tableHeight: 250,
      moduleType: '/ols/cradlegroupmember-export',
      studyId: '',
      uploadUrl: '',
      downloadUrl: '',
      contractList: [],
  ...
  mounted() {
    ...
    this.uploadUrl = process.env.BASE_API + 'ols/cradlegroupmember-import-' + this.studyId + '.json'
    this.getList()
  },
  methods: {
    getdetault() {
    ...
    getList() {
      ...
      getcradlegroupmember(this.studyId, that.searchInfo).then(res => {
        ...
        if (res.code === 200) {
          console.log(res)
          that.tableData = res.data.cradlegroupmember
