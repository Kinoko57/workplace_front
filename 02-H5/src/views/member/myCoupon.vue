  ...
  <div>
    ...
    <div class='my_coupon'>
      ...
      <div class='coupon_body'>
        ...
        <div class='cou_list' v-if='couList.length>0' v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" infinite-scroll-distance="30">
          <div class='cou_info' v-for="(item,index) in couList" :key="index">
            <img :src='imgPath+"order/cop_bg.png"' :hidden="couType!='1'" />
            <img :src='imgPath+"order/cop_bg_01.png"' :hidden="couType=='1'" />
            <div class='cou_more'>
              <div class='cou_value'>￥
        ...
        <div class='cou_list_null' v-if='couList.length<=0'>
          <!-- <span class='nullTips'>当前分类下暂无优惠券</span> -->
          <img :src='imgPath+"pro/null_4.png"'/>
        </div>
      </div>
