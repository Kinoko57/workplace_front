...
function getIndex(areaArr) {
  console.log(areaArr)
  for (var i = 0; i < AreaJson.length; i++) {
    if (areaArr[0] == AreaJson[i].name) {
      for (var j = 0; j < AreaJson[i].city.length; j++) {
        if (areaArr[1] == AreaJson[i].city[j].name) {
          for (var k = 0; k < AreaJson[i].city[j].area.length; k++) {
            if (areaArr[2] == AreaJson[i].city[j].area[k]) {
              return [i, j, k]
            }
          }
        }
