...
export function getActivityList() {
  return request({
    url: '?m=list&a=schemeList',
    method: 'GET'
  })
}
// 获取首页推荐商品列表
export function getRecomProList() {
  return request({
    url: '?m=list&a=getHotGoods',
    method: 'GET'
  })
}
// 获取猜你喜欢商品列表
...
export function getCarList() {
  return request({
    url: '?m=cart&a=cart_change',
    method: 'GET'
  })
}
// 不修改库存的获取购物车
export function getCarListByCar() {
  return request({
    url: '?m=cart&a=cart_change',
    method: 'GET'
  })
...
// 确认订单校验库存
export function checkSubmit(info) {
  return request({
    url: '?m=cart&a=checkout_cart',
    method: 'POST',
    data: info
  })
}
...
// 获取本人抽奖记录
export function getWinList(genre) {
  return request({
    url: '?m=lottery&a=info&page=1&type=0&limit=20&genre=' + genre,
    method: 'GET'
  })
}
// 领取非实物中奖
...
// 获取购物车推荐商品
export function getRecommByPro(id) {
  return request({
    url: '?m=item&a=item_related&id=' + id,
    method: 'GET'
  })
}
// 选择商品规格得出具体价格和库存
...
// 领奖接口，通促销
export function addCarofGift(info) {
  return request({
    url: '?m=listexchange&a=add',
    method: 'GET',
    params: info
...
// 获取是否显示分享功能
export function getShowShare() {
  return request({
    url: '?m=myinfo&a=shop_start',
    method: 'GET'
  })
}
...
// 保存备注信息
export function saveRemarksInfo(info) {
  return request({
    url: '?m=invite&a=addRemark',
    method: 'POST',
    data: info
  })
}
...
// 请求微信支付回调
export function isPayOk(info) {
  return request({
    url: '?m=apipayment&a=accord',
    method: 'GET',
    params: info
  })
}
...
// 活动列表
export function getActivityListInfo(id) {
  return request({
    url: '?m=list&a=schemeGoodsList&scheme_id=' + id,
    method: 'GET'
  })
}
// 获取广告页
export function getAdvImg() {
  return request({
    url: '?m=img',
    method: 'GET'
  })
